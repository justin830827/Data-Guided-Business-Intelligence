...
# ===== Reading the graph ====== #
g <- read.graph(file="./Desktop/data/fb_caltech_small_edgelist.txt", format = c("edgelist"))

# ===== Read communities file ==== #
comm = integer(vcount(g))

conn <- file("./Desktop/communities.txt", open="r")
...
attrData <- read.csv("./Desktop/data/fb_caltech_small_attrlist.csv")
